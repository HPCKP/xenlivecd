...
lh_config \
    ...
    --packages "squashfs-tools aufs-tools bridge-utils xen-linux-system-2.6.26-2-xen-amd64 xen-hypervisor-3.2-1-amd64 xen-utils-3.2-1 xen-docs-3.2 libvirt-bin less virt-manager virt-viewer xen-tools xorg x11-xserver-utils gnome-session gnome-panel gdm evince metacity gnome-terminal gnome-backgrounds gnome-themes nautilus tsclient mesa-utils vinagre gnome-system-monitor lvm2 mdadm dmraid iceweasel gedit kpartx parted gparted ntfsprogs ntfs-3g vim telnet screen vncviewer mlocate desktop-base vlan vtun vde2 vdetelweb redhat-cluster-suite aoetools vblade vblade-persist python-rpm yelp iscsitarget open-iscsi isns isns-client ssh iscsitarget-modules-2.6-amd64 iscsitarget-modules-2.6-xen-amd64 mc ganeti ganeti-instance-debootstrap firmware-bnx2 snmpd" \
